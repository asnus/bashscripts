...
#import webbrowser
#webbrowser.register('iexplore', None, webbrowser.GenericBrowser('C:\\Program Files (x86)\\Internet Explorer\\iexplore.exe'))
#c.NotebookApp.browser = 'iexplore'

## SSL/TLS 认证文件所在全路径.
#c.NotebookApp.certfile = '/home/guest/.jupyter/notebookcert.pem'
...
## SSL/TLS 私钥文件所在全路径.
#c.NotebookApp.keyfile = '/home/guest/.jupyter/notebook.key'
...
## 用于笔记本和内核的目录。
#c.NotebookApp.notebook_dir = '/home/guest/notebook'
...
c.NotebookApp.password = 'sha1:a55c8673f02c:39b431e7133b5c4100d388a95dd21e413b4f0b52'
